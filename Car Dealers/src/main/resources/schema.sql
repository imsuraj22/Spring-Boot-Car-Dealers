CREATE TABLE New_Cars (id INT NOT NULL Primary Key AUTO_INCREMENT, make VARCHAR(100), model VARCHAR(100), colour VARCHAR(100), price DECIMAL(12,2), vin VARCHAR(100));

INSERT INTO New_Cars (make, model, colour, price, vin) VALUES 
...
CREATE TABLE Second_Hand_Cars (id INT NOT NULL Primary Key AUTO_INCREMENT, make VARCHAR(100), model VARCHAR(100), colour VARCHAR(100), price DECIMAL(12,2), vin VARCHAR(100));

INSERT INTO Second_Hand_Cars (make, model, colour, price, vin) VALUES 
...
CREATE TABLE Super_Cars (id INT NOT NULL Primary Key AUTO_INCREMENT, make VARCHAR(100), model VARCHAR(100), colour VARCHAR(100), price DECIMAL(12,2), vin VARCHAR(100));

INSERT INTO Super_Cars (make, model, colour, price, vin) VALUES 
