package com.suraj.springweb.controllers;
...
import com.suraj.springweb.beans.Car;
import com.suraj.springweb.database.DatabaseAccess;
...
public class HomeController {
	...
	{
		model.addAttribute("carsFromD1",dataObj.getCars("New_Cars"));
		model.addAttribute("carsFromD2",dataObj.getCars("Second_Hand_Cars"));
		model.addAttribute("carsFromD3",dataObj.getCars("Super_Cars"));
		return "viewCar.html";
	}
	...
	{
		model.addAttribute("carsFromD1",dataObj.searchCarById(id,"New_Cars"));
		model.addAttribute("carsFromD2",dataObj.searchCarById(id,"Second_Hand_Cars"));
		model.addAttribute("carsFromD3",dataObj.searchCarById(id,"Super_Cars"));
		return "viewCar.html";
	}
	...
	{
		model.addAttribute("carsFromD1",dataObj.searchCarByMake(make,"New_Cars"));
		model.addAttribute("carsFromD2",dataObj.searchCarByMake(make,"Second_Hand_Cars"));
		model.addAttribute("carsFromD3",dataObj.searchCarByMake(make,"Super_Cars"));
		return "viewCar.html";
	}
	...
	{
		model.addAttribute("carsFromD1",dataObj.searchCarByModel(modelForCar,"New_Cars"));
		model.addAttribute("carsFromD2",dataObj.searchCarByModel(modelForCar,"Second_Hand_Cars"));
		model.addAttribute("carsFromD3",dataObj.searchCarByModel(modelForCar,"Super_Cars"));
		return "viewCar.html";
	}
	...
	{
		model.addAttribute("carsFromD1",dataObj.searchCarByPrice(min,max,"New_Cars"));
		model.addAttribute("carsFromD2",dataObj.searchCarByPrice(min,max,"Second_Hand_Cars"));
		model.addAttribute("carsFromD3",dataObj.searchCarByPrice(min,max,"Super_Cars"));
		return "viewCar.html";
	}
